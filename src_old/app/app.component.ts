...
export class AppComponent {
  ...
  i18ndatas: object = {
    en: {
      ...
      devcom_docnum: "Document Number",
      devcom_doclang: "Language",
      devcom_year: "Meeting Year",
      devcom_speaker: "Speaker",
      devcom_year__devcom_meetype: "Meeting",
    },
  };
  langVal = "en";
  devcommittee: string;
  ...
  constructor(
    ...
    this.devcommittee = this.element.nativeElement.getAttribute("devcommittee");
    this.inputUrl = this.element.nativeElement.getAttribute("url");
    this.facetKeys = this.element.nativeElement.getAttribute("facetKeys");
    this.listingTitles =
      this.element.nativeElement.getAttribute("listingTitles");
    this.subKey = this.element.nativeElement.getAttribute("subKey");
    this.localeUrl = "";
    ...
    //console.log("inputParameters", this.inputParameters);
  }
  ...
  public updateParameter(parameter: any) {
    ...
    for (const key in this.facetParameters) {
      if (this.facetParameters.hasOwnProperty(key) && key != "lang_exact") {
        let value = this.facetParameters[key];
